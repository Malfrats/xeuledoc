...
def doc_hunt(doc_link):
    ...
    created_date = datetime.strptime(data.get("createdDate","1970-01-01T00:00:01.000z"), '%Y-%m-%dT%H:%M:%S.%fz')
    modified_date = datetime.strptime(data.get("modifiedDate","1970-01-01T00:00:01.000z"), '%Y-%m-%dT%H:%M:%S.%fz')
    ...
    user_permissions = []
    if data.get("userPermission",False):
